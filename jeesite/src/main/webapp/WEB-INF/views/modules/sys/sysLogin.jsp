...
<body style="background-image: url(C:\Users\panqian\Pictures\background.png);">
	...
	<form id="loginForm" class="form-signin" action="${ctx}/login" method="post">
		...
		<input class="button button-glow button-rounded button-raised button-primary" type="submit" value="登 录"/>&nbsp;&nbsp;
