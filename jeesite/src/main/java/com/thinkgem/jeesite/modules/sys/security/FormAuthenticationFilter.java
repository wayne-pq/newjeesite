...
public class FormAuthenticationFilter extends
	...
	public static String loginplace = "";
	...
	protected AuthenticationToken createToken(ServletRequest request,
		...
		URI = ((HttpServletRequest) request).getRequestURL().toString();

		URI = request.getScheme() + "://" + request.getServerName() + ":"
				+ request.getServerPort()
				+ ((HttpServletRequest) request).getContextPath() + "/";

		loginplace = WebUtils.getCleanParam(request, "loginplace");
		if (password == null) {
			password = "";
		}
	...
	public String getSuccessUrl() {
		/*if (null != loginplace && !"".equals(loginplace)
			...
			return StringUtils.replaceLast((URI + Global.getConfig("frontPath")),"//","/");*/
